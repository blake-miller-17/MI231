...
public class Main : MonoBehaviour
{
    ...
    static private Dictionary<eWeaponType, WeaponDefiniton> WEAP_DICT;
    ...
    public WeaponDefiniton[] weaponDefinitions;
...
public void SpawnEnemy()
    ...
    static public WeaponDefiniton GET_WEAPON_DEFINITION( eWeaponType wt)
    {
