...
public class TileSwapEditor : PropertyDrawer {
    ...
    private const float cPrefabLabelWidth = 90;
    ...
    void PrepRects(float lineHeight = 18) {
        ...
        RECT_DICT.Add( "itemDropLabel", new Rect( cSpriteSize+cBorder, lineHeight*2, cPrefabLabelWidth, lineHeight ) );
        RECT_DICT.Add( "guaranteedItem", new Rect( cSpriteSize+cBorder+cPrefabLabelWidth, lineHeight*2, -(cSpriteSize+cBorder)*2-cPrefabLabelWidth, lineHeight ) );
        ...
        // RECT_DICT.Add( "itemDropLabel", new Rect( 80, lineHeight, 64, lineHeight ) );
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
        ...
        foreach ( string prop in RECT_DICT.Keys ) { 
            ...
            switch ( prop ) {
                ...
                case "swapPrefabLabel":
                    EditorGUI.LabelField(relRect, "SwapPrefab");
                    break;
                case "itemDropLabel":
                    EditorGUI.LabelField(relRect, "ItemDropPrefab");
                    break;
        ...
        // EditorGUI.PropertyField(rItemDrop, property.FindPropertyRelative("guaranteedItemDrop"), GUIContent.none);
...
//     SerializedProperty guaranteedItemDrop;
...
//         guaranteedItemDrop = serializedObject.FindProperty( "guaranteedItemDrop" );
...
//         EditorGUILayout.PropertyField( guaranteedItemDrop );
